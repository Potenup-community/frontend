...
import { api, postApi, fileApi } from '@/lib/api';
    ...
    return (
      <div className="flex flex-col h-screen bg-background">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          <Button variant="linear" onClick={() => router.push('/')}>홈으로</Button>
        </div>
      </div>
    );
  }
    ...
    <div className="flex flex-col h-screen bg-background overflow-hidden">
      ...
      <div className="flex items-center justify-between px-6 py-3 border-b bg-card/50 backdrop-blur-sm">
        ...
        <div className="flex items-center gap-2">
          ...
          >
            {isSubmitting ? <Loader2 className="h-4 w-4 animate-spin" /> : '수정하기'}
          </Button>
        </div>
      </div>
